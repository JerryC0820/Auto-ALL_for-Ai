...
在仓库目录执行：
```
py -m PyInstaller --noconfirm --clean --name "牛马神器_v4.0.13" --icon "assets\牛马爱摸鱼V2.01.ico" --add-data "assets;assets" --windowed "牛马神器_v4.0.13.py"
```
输出目录：`dist\牛马神器_v4.0.13\`
